...
class _$InventoryImpl implements _Inventory {
  ...
  @override
  String toString() {
    return 'Inventory(id: $id, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, syncStatus: $syncStatus, version: $version)';
  }
...
abstract class _Inventory implements Inventory {
  const factory _Inventory(
      ...
      required final int version}) = _$InventoryImpl;
